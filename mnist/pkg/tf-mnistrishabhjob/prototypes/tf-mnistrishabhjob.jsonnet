// @apiVersion 0.1
// @name io.ksonnet.pkg.tf-mnistrishabhjob
...
local util = import "ciscoai/tf-mnistrishabhjob/util.libsonnet";
...
local tfJob = import "ciscoai/tf-mnistrishabhjob/tf-job.libsonnet";
